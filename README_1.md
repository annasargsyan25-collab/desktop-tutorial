...
A keyword-matched FAQ chatbot docked bottom-right, with its own close
button in the panel header. Answers common questions (how to rent,
pricing, categories, late returns, how many books at once, changing
language, etc.) in the active site language, with quick reply
suggestions. Fully client-side, no external API.
